...
def get_subfolders(parent_folder_id):
    ...
    subfolders = client.get(
        f"/folder", parameters={"parentType": "folder", "parentId": parent_folder_id}
    )
...
def ni_model(file_name, file_path, component):
    ...
    ni_folder_id = find_folder_by_path(
        "66310ca21b56c53abc7e0f9f", ni_data["targetPath"]
    )

    dms_ni_folder_items = client.get(
        f"/item",
        parameters={
...
def eds_model(file_name, file_path, component):
    ...
    def make_ebsd_eds_mapping_sequence(data):
        ...
        ebsd_eds_mapping_process = Process(
            name="EBSD and EDS Mapping", template=ebsd_eds_mapping_process_template
        )
        ...
        ebsd_eds_mapping_process.update_parameters(
            ...
            Parameter(
                "Low Vacuum",
                value=NominalCategorical(data["EBSD and EDS Mapping"]["Low Vacuum"]),
        ...
        eds_measured_composition.update_parameters(
            ...
            Parameter(
                "V",
                value=NominalReal(data["Results"]["Measured Composition (%)"]["V"], ""),
                template=composition_parameter_template,
            ),
            which="run",
        )
        ...
        eds_measured_composition_stddev.update_parameters(
            Parameter(
                "Al",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["Al"], ""
                ),
            ...
            Parameter(
                "Co",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["Co"], ""
                ),
                template=composition_std_parameter_template,
            ),
            Parameter(
                "Cr",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["Cr"], ""
                ),
                template=composition_std_parameter_template,
            ),
            Parameter(
                "Cu",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["Cu"], ""
                ),
                template=composition_std_parameter_template,
            ),
            Parameter(
                "Fe",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["Fe"], ""
                ),
                template=composition_std_parameter_template,
            ),
            Parameter(
                "Mn",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["Mn"], ""
                ),
                template=composition_std_parameter_template,
            ),
            Parameter(
                "Ni",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["Ni"], ""
                ),
                template=composition_std_parameter_template,
            ),
            Parameter(
                "V",
                value=NominalReal(
                    data["Results"]["Measured Composition StdDev (%)"]["V"], ""
                ),
                template=composition_std_parameter_template,
            ),
            which="run",
        ...
        eds_2nd_phase_measured_composition.update_parameters(
            Parameter(
                "Al",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["Al"], ""
                ),
                template=composition_parameter_template,
            ),
            Parameter(
                "Co",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["Co"], ""
                ),
                template=composition_parameter_template,
            ),
            Parameter(
                "Cr",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["Cr"], ""
                ),
                template=composition_parameter_template,
            ),
            Parameter(
                "Cu",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["Cu"], ""
                ),
                template=composition_parameter_template,
            ),
            Parameter(
                "Fe",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["Fe"], ""
                ),
                template=composition_parameter_template,
            ),
            Parameter(
                "Mn",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["Mn"], ""
                ),
                template=composition_parameter_template,
            ),
            Parameter(
                "Ni",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["Ni"], ""
                ),
                template=composition_parameter_template,
            ),
            Parameter(
                "V",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition (%)"]["V"], ""
                ),
                template=composition_parameter_template,
            ),
            which="run",
        ...
        eds_2nd_phase_measured_composition_stddev.update_parameters(
            Parameter(
                "Al",
                value=NominalReal(
                    data["Results"]["2nd Phase EDS Measured Composition StdDev (%)"][
                        "Al"
                    ],
                    "",
                ),
    ...
    def make_forging_sequence(data):
        ...
        dimensions_before_measurement.update_properties(  # TODO: add thickness reduction
            Property(
                "Prior Length",
                value=NominalReal(
                    synthesis_data["Forging"]["Ingot Dimensions Before"]["Length"], "cm"
                ),
            ...
            Property(
                "Prior Thickness",
                value=NominalReal(
                    synthesis_data["Forging"]["Ingot Dimensions Before"]["Thickness"],
                    "cm",
                ),
                template=dimension_property_template,
            ),
            Property(
                "Prior Width",
                value=NominalReal(
                    synthesis_data["Forging"]["Ingot Dimensions Before"]["Width"], "cm"
                ),
                template=dimension_property_template,
            ),
            which="run",
        ...
        dimensions_after_measurement.update_properties(  # TODO: add thickness reduction
            Property(
                "Posterior Length",
                value=NominalReal(
                    synthesis_data["Forging"]["Ingot Dimensions After"]["Length"], "cm"
                ),
                template=dimension_property_template,
            ),
            Property(
                "Posterior Thickness",
                value=NominalReal(
                    synthesis_data["Forging"]["Ingot Dimensions After"]["Thickness"],
                    "cm",
                ),
                template=dimension_property_template,
            ),
            Property(
                "Posterior Width",
                value=NominalReal(
                    synthesis_data["Forging"]["Ingot Dimensions After"]["Width"], "cm"
                ),
                template=dimension_property_template,
            ),
            which="run",
    ...
    def make_homogenization_sequence(data, ingredient_name):
        ...
        homogenization_process.update_parameters(
            ...
            Parameter(
                "Duration",
                value=NominalReal(
                    data["Homogenization"]["Thermal Conditions"]["Duration"], "hours"
                ),
        ...
        time_spent_measurement.update_parameters(
            Parameter(
                "Time", value=NominalReal(5, "hours"), template=time_parameter_template
            )
        )
    ...
    def make_arc_melting_sequence(data, ingredient_name):
        ...
        arc_melting_process.update_conditions(
            ...
            Condition(
                "Vacuum Before Melt",
                value=NominalReal(
                    data["Arc Melting"]["VAM Details"]["Vacuum Before Melt"], "pascal"
                ),
...
class BIRDSHOTModeller(GEMDModeller):
    ...
    def __init__(self, files_folder, gemd_folder, instantiate_build):
        ...
        self.add_automatable_component(
            ...
            (r"\b[A-Z]{3}[0-9]{2}\b", True),
            [],
            lambda file_name, file_path, component: eds_model(
                file_name, file_path, component
            ),
        )
        self.add_automatable_component(
